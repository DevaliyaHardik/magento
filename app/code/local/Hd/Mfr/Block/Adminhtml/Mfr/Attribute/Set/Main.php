...
class Hd_Mfr_Block_Adminhtml_Mfr_Attribute_Set_Main extends Mage_Adminhtml_Block_Catalog_Product_Attribute_Set_Main {
	...
	public function getGroupTreeJson() {
		...
		foreach ($groups as $node) {
			...
			$nodeChildren = Mage::getResourceModel('eav/entity_attribute_collection')->setEntityTypeFilter(Mage::getModel('eav/entity')->setType(Hd_Mfr_Model_Resource_Mfr::ENTITY)->getTypeId())
			...
			if ($nodeChildren->getSize() > 0) {
				...
				foreach ($nodeChildren->getItems() as $child) {
					...
					$attr = array(
						...
						'cls' => (!$child->getIsMfrDefined()) ? 'system-leaf' : 'leaf',
						'allowDrop' => false,
						'allowDrag' => true,
						'leaf' => true,
						'is_mfr_defined' => $child->getIsMfrDefined(),
	...
	public function getAttributeTreeJson() {
		...
		$attributes = Mage::getResourceModel('eav/entity_attribute_collection')->setEntityTypeFilter(Mage::getModel('eav/entity')->setType(Hd_Mfr_Model_Resource_Mfr::ENTITY)->getTypeId())
