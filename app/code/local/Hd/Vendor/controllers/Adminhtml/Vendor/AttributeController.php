<?php
class Hd_Vendor_Adminhtml_Vendor_AttributeController extends Mage_Adminhtml_Controller_Action {
	...
	public function preDispatch() {
		parent::preDispatch();
		$this->_entityTypeId = Mage::getModel('eav/entity')->setType(Hd_Vendor_Model_Resource_Vendor::ENTITY)->getTypeId();
	}
