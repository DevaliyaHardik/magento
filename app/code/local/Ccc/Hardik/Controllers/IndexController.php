<?php
class Ccc_Hardik_IndexController extends Mage_Core_Controller_Front_Action
{
    ...
    public function saveAction()
    {
        ...
        $contact = Mage::getModel('hardik/hardik');
        ...
        $contact->save();       
        $this->_redirect('hardik/index/index');
    }
    public function deletedataAction()
    {
            $id     = $this->getRequest()->getParam('id');
            $model2  = Mage::getModel('hardik/hardik')->load($id);
            $model2->delete();
                $this->_redirect('*/*/');
    }
    ...
    {
        $id     = $this->getRequest()->getParam('id');      
        $model  = Mage::getModel('hardik/hardik')->load($id);
